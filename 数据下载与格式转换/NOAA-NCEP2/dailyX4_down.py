...
surface = ['mslp', 'pres.sfc', 'pr_wtr.eatm', 'land', 'hgt.sfc', 'topo.sfc']
...
spectral = ['div.spec', 'pres.nlog.sfc.spec', 'shum.spec', 'vair.spec', 'vort.spec']
...
if __name__ == "__main__":
	...
	for dirname in dirnames.keys():
		...
		for var in dirnames[dirname]:
			if var not in ['land', 'hgt.sfc', 'topo.sfc', 'hgt.sfc.gauss', 'land.sfc.gauss', 'orog.spec']:
